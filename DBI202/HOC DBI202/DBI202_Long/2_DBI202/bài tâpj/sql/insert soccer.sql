...
use FootballManage
INSERT INTO Sponsors( SponsorId, Name, TeamId, ContractStart, ContractEnd)
VALUES
(1,'TeamViewer',1,'2012/06/30','2030/06/20'),
(2,'Standard chartered',2,'2018/06/20','2026/06/20'),
(3,'Three',3,'2020/06/20','2023/06/20'),
(4,'Etihad airway',4,'2010/06/20','2040/06/20'),
(5,'AIA',5,'2020/06/20','2026/06/20'),
(6,'Emirates',6,'2015/06/20','2026/06/20'),
(7,'FUN88',1,'2020/06/20','2024/06/20'),
(8,'W88',8,'2021/06/20','2026/06/20'),
(9,'American express',1,'2018/06/21','2028/06/20'),
(10,'HOLLYWOOD bets',1,'2022/06/20','2026/06/20')
