...
********************************************************************************/
IF EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE name = N'PE_DBI202_F2019')
BEGIN
	ALTER DATABASE [PE_DBI202_F2019] SET OFFLINE WITH ROLLBACK IMMEDIATE;
	ALTER DATABASE [PE_DBI202_F2019] SET ONLINE;
	DROP DATABASE [PE_DBI202_F2019];
END

GO

/****** Object:  Database [PE_DBI202_F2019]    Script Date: 22/10/2019 05:25:15 ******/
CREATE DATABASE [PE_DBI202_F2019]
GO
ALTER DATABASE [PE_DBI202_F2019] SET COMPATIBILITY_LEVEL = 140
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [PE_DBI202_F2019].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [PE_DBI202_F2019] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [PE_DBI202_F2019] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [PE_DBI202_F2019] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [PE_DBI202_F2019] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [PE_DBI202_F2019] SET ARITHABORT OFF 
GO
ALTER DATABASE [PE_DBI202_F2019] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [PE_DBI202_F2019] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [PE_DBI202_F2019] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [PE_DBI202_F2019] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [PE_DBI202_F2019] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [PE_DBI202_F2019] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [PE_DBI202_F2019] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [PE_DBI202_F2019] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [PE_DBI202_F2019] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [PE_DBI202_F2019] SET  ENABLE_BROKER 
GO
ALTER DATABASE [PE_DBI202_F2019] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [PE_DBI202_F2019] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [PE_DBI202_F2019] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [PE_DBI202_F2019] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [PE_DBI202_F2019] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [PE_DBI202_F2019] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [PE_DBI202_F2019] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [PE_DBI202_F2019] SET RECOVERY FULL 
GO
ALTER DATABASE [PE_DBI202_F2019] SET  MULTI_USER 
GO
ALTER DATABASE [PE_DBI202_F2019] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [PE_DBI202_F2019] SET DB_CHAINING OFF 
GO
ALTER DATABASE [PE_DBI202_F2019] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [PE_DBI202_F2019] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
ALTER DATABASE [PE_DBI202_F2019] SET DELAYED_DURABILITY = DISABLED 
GO
EXEC sys.sp_db_vardecimal_storage_format N'PE_DBI202_F2019', N'ON'
GO
ALTER DATABASE [PE_DBI202_F2019] SET QUERY_STORE = OFF
GO
USE [PE_DBI202_F2019]
GO
/****** Object:  Table [dbo].[Countries]    Script Date: 22/10/2019 05:25:15 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Departments]    Script Date: 22/10/2019 05:25:15 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[JobHistory]    Script Date: 22/10/2019 05:25:15 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Jobs]    Script Date: 22/10/2019 05:25:15 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Regions]    Script Date: 22/10/2019 05:25:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT [dbo].[Departments] ([DepartmentID], [DepartmentName], [ManagerID], [LocationID]) VALUES (10, N'Administration', 200, N'1700')
INSERT [dbo].[Departments] ([DepartmentID], [DepartmentName], [ManagerID], [LocationID]) VALUES (20, N'Marketing', 201, N'1800')
INSERT [dbo].[Departments] ([DepartmentID], [DepartmentName], [ManagerID], [LocationID]) VALUES (30, N'Purchasing', 114, N'1700')
INSERT [dbo].[Departments] ([DepartmentID], [DepartmentName], [ManagerID], [LocationID]) VALUES (40, N'Human Resources', 203, N'2400')
...
INSERT [dbo].[Departments] ([DepartmentID], [DepartmentName], [ManagerID], [LocationID]) VALUES (70, N'Public Relations', 204, N'2700')
...
INSERT [dbo].[Departments] ([DepartmentID], [DepartmentName], [ManagerID], [LocationID]) VALUES (110, N'Accounting', 205, N'1700')
...
GO
INSERT [dbo].[Employees] ([EmployeeID], [FirstName], [LastName], [Email], [Phone], [HireDate], [JobID], [Salary], [Commission_pct], [ManagerID], [DepartmentID]) VALUES (200, N'Jennifer', N'Whalen', N'JWHALEN', N'5.151.234.444', CAST(N'2003-09-17' AS Date), N'AD_ASST', 4400, 0, 101, 10)
INSERT [dbo].[Employees] ([EmployeeID], [FirstName], [LastName], [Email], [Phone], [HireDate], [JobID], [Salary], [Commission_pct], [ManagerID], [DepartmentID]) VALUES (201, N'Michael', N'Hartstein', N'MHARTSTE', N'5.151.235.555', CAST(N'2004-02-17' AS Date), N'MK_MAN', 13000, 0, 100, 20)
INSERT [dbo].[Employees] ([EmployeeID], [FirstName], [LastName], [Email], [Phone], [HireDate], [JobID], [Salary], [Commission_pct], [ManagerID], [DepartmentID]) VALUES (202, N'Pat', N'Fay', N'PFAY', N'6.031.236.666', CAST(N'2005-08-17' AS Date), N'MK_REP', 6000, 0, 201, 20)
INSERT [dbo].[Employees] ([EmployeeID], [FirstName], [LastName], [Email], [Phone], [HireDate], [JobID], [Salary], [Commission_pct], [ManagerID], [DepartmentID]) VALUES (203, N'Susan', N'Mavris', N'SMAVRIS', N'5.151.237.777', CAST(N'2002-06-07' AS Date), N'HR_REP', 6500, 0, 101, 40)
INSERT [dbo].[Employees] ([EmployeeID], [FirstName], [LastName], [Email], [Phone], [HireDate], [JobID], [Salary], [Commission_pct], [ManagerID], [DepartmentID]) VALUES (204, N'Hermann', N'Baer', N'HBAER', N'5.151.238.888', CAST(N'2002-06-07' AS Date), N'PR_REP', 10000, 0, 101, 70)
INSERT [dbo].[Employees] ([EmployeeID], [FirstName], [LastName], [Email], [Phone], [HireDate], [JobID], [Salary], [Commission_pct], [ManagerID], [DepartmentID]) VALUES (205, N'Shelley', N'Higgins', N'SHIGGINS', N'5.151.238.080', CAST(N'2002-06-07' AS Date), N'AC_MGR', 12000, 0, 101, 110)
INSERT [dbo].[Employees] ([EmployeeID], [FirstName], [LastName], [Email], [Phone], [HireDate], [JobID], [Salary], [Commission_pct], [ManagerID], [DepartmentID]) VALUES (206, N'William', N'Gietz', N'WGIETZ', N'5.151.238.181', CAST(N'2002-06-07' AS Date), N'AC_ACCOUNT', 8300, 0, 205, 110)
INSERT [dbo].[JobHistory] ([EmployeeID], [Start_date], [End_date], [JobID], [DepartmentID]) VALUES (201, CAST(N'2004-02-17' AS Date), CAST(N'2007-12-19' AS Date), N'MK_REP', 20)
INSERT [dbo].[JobHistory] ([EmployeeID], [Start_date], [End_date], [JobID], [DepartmentID]) VALUES (200, CAST(N'2002-07-01' AS Date), CAST(N'2006-12-31' AS Date), N'AC_ACCOUNT', 90)
INSERT [dbo].[JobHistory] ([EmployeeID], [Start_date], [End_date], [JobID], [DepartmentID]) VALUES (200, CAST(N'1995-09-17' AS Date), CAST(N'2001-06-17' AS Date), N'AD_ASST', 90)
INSERT [dbo].[JobHistory] ([EmployeeID], [Start_date], [End_date], [JobID], [DepartmentID]) VALUES (176, CAST(N'2007-01-01' AS Date), CAST(N'2007-12-31' AS Date), N'SA_MAN', 80)
INSERT [dbo].[JobHistory] ([EmployeeID], [Start_date], [End_date], [JobID], [DepartmentID]) VALUES (176, CAST(N'2006-03-24' AS Date), CAST(N'2006-12-31' AS Date), N'SA_REP', 80)
INSERT [dbo].[JobHistory] ([EmployeeID], [Start_date], [End_date], [JobID], [DepartmentID]) VALUES (122, CAST(N'2007-01-01' AS Date), CAST(N'2007-12-31' AS Date), N'ST_CLERK', 50)
INSERT [dbo].[JobHistory] ([EmployeeID], [Start_date], [End_date], [JobID], [DepartmentID]) VALUES (114, CAST(N'2006-03-24' AS Date), CAST(N'2007-12-31' AS Date), N'ST_CLERK', 50)
INSERT [dbo].[JobHistory] ([EmployeeID], [Start_date], [End_date], [JobID], [DepartmentID]) VALUES (102, CAST(N'2001-01-13' AS Date), CAST(N'2006-07-24' AS Date), N'IT_PROG', 60)
INSERT [dbo].[JobHistory] ([EmployeeID], [Start_date], [End_date], [JobID], [DepartmentID]) VALUES (101, CAST(N'2001-10-28' AS Date), CAST(N'2005-03-15' AS Date), N'AC_MGR', 110)
INSERT [dbo].[JobHistory] ([EmployeeID], [Start_date], [End_date], [JobID], [DepartmentID]) VALUES (101, CAST(N'1997-09-21' AS Date), CAST(N'2001-10-27' AS Date), N'AC_ACCOUNT', 110)
...
INSERT [dbo].[Jobs] ([JobID], [JobTitle], [min_salary], [max_salary]) VALUES (N'PR_REP', N'Public Relations Representative', 4500, 10500)
...
INSERT [dbo].[Locations] ([LocationID], [StreetAddress], [PostalCode], [City], [StateProvince], [CountryID]) VALUES (N'1000', N'1297 Via Cola di Rie', N'989', N'Roma', NULL, N'IT')
...
INSERT [dbo].[Locations] ([LocationID], [StreetAddress], [PostalCode], [City], [StateProvince], [CountryID]) VALUES (N'1900', N'6092 Boxwood St', N'YSW 9T2', N'Whitehorse', N'Yukon', N'CA')
...
INSERT [dbo].[Locations] ([LocationID], [StreetAddress], [PostalCode], [City], [StateProvince], [CountryID]) VALUES (N'2100', N'1298 Vileparle (E)', N'490231', N'Bombay', N'Maharashtra', N'IN')
...
INSERT [dbo].[Locations] ([LocationID], [StreetAddress], [PostalCode], [City], [StateProvince], [CountryID]) VALUES (N'2800', N'Rua Frei Caneca 1360', N'01307-002', N'Sao Paulo', N'Sao Paulo', N'BR')
...
INSERT [dbo].[Locations] ([LocationID], [StreetAddress], [PostalCode], [City], [StateProvince], [CountryID]) VALUES (N'3200', N'Mariano Escobedo 9991', N'11932', N'Mexico City', N'Distrito Federal', N'MX')
...
REFERENCES [dbo].[Employees] ([EmployeeID])
GO
ALTER TABLE [dbo].[JobHistory]  WITH CHECK ADD FOREIGN KEY([DepartmentID])
REFERENCES [dbo].[Departments] ([DepartmentID])
GO
ALTER TABLE [dbo].[JobHistory]  WITH CHECK ADD FOREIGN KEY([EmployeeID])
REFERENCES [dbo].[Employees] ([EmployeeID])
GO
ALTER TABLE [dbo].[JobHistory]  WITH CHECK ADD FOREIGN KEY([JobID])
REFERENCES [dbo].[Jobs] ([JobID])
GO
...
USE [master]
GO
ALTER DATABASE [PE_DBI202_F2019] SET  READ_WRITE 
GO
